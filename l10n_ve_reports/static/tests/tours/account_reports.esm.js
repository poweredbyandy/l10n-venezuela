    ...
    steps: () => [
        ...
        // --------------------------------------------------------------------------------------------------------------
        {
            ...
            run: () => {
                ...
                Asserts.isEqual(
                    globalThis.document.querySelector("tr:nth-child(4) td:nth-child(2)")
                        .textContent,
                    "75.00"
                );
            },
        ...
        },
        {
            ...
            run: () => {
                ...
                Asserts.isEqual(
                    globalThis.document.querySelector("tr:nth-child(5) td:nth-child(2)")
                        .textContent,
                    "75.00"
                );
                Asserts.isEqual(
                    globalThis.document.querySelector("tr:nth-child(6) td:nth-child(2)")
                        .textContent,
                    "75.00"
                );
                ...
                // Receivables
                Asserts.isEqual(
                    globalThis.document.querySelector("tr:nth-child(8) td:nth-child(2)")
                        .textContent,
                    "25.00"
                );
                Asserts.isEqual(
                    globalThis.document.querySelector("tr:nth-child(9) td:nth-child(2)")
                        .textContent,
                    "25.00"
                );
