...
registry.category("web_tour.tours").add("account_reports_annotations", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".o_content",
            run: () => {
                const annotations = globalThis.document.querySelectorAll(
        ...
        },
        {
            ...
            run: function () {
                ...
                annotation.dispatchEvent(new globalThis.InputEvent("input"));
                annotation.dispatchEvent(new globalThis.Event("change"));
            },
        },
        {
            ...
            run: () => {
                Asserts.isEqual(
                    globalThis.document.querySelector(
                        ".annotation_popover_autoresize_textarea"
                    ).value,
