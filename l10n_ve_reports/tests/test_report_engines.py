...
class TestReportEngines(TestAccountReportsCommon):
    ...
    def test_engine_account_codes(self):
        ...
        test_line_14 = self._prepare_test_report_line(
            self._prepare_test_expression_account_codes(
                r"tag(account_reports.account_codes_engine_test_tag1)D"
            ),
            groupby="account_id",
        )
        test_line_15 = self._prepare_test_report_line(
            self._prepare_test_expression_account_codes(
                r"tag(account_reports.account_codes_engine_test_tag1)C"
            ),
            groupby="account_id",
        )
    ...
    def test_engine_aggregation_cross_report(self):
        moves = self._create_test_account_moves(
            [
                self._prepare_test_account_move_line(
                    1.0, account_code="100000", date="2020-01-01"
                ),
                self._prepare_test_account_move_line(
                    2.0, account_code="100000", date="2021-01-01"
                ),
                self._prepare_test_account_move_line(
                    3.0, account_code="200000", date="2020-01-01"
                ),
                self._prepare_test_account_move_line(
                    4.0, account_code="200000", date="2021-01-01"
                ),
                self._prepare_test_account_move_line(
                    5.0, account_code="300000", date="2021-01-01"
                ),
            ]
        )
        ...
        other_report_line_1 = self._prepare_test_report_line(
            self._prepare_test_expression_account_codes("1"),
            name="other_report_line_1",
            code="other_report_line_1",
        )

        other_report_line_2 = self._prepare_test_report_line(
            self._prepare_test_expression_account_codes("2"),
            name="other_report_line_2",
            code="other_report_line_2",
        )

        other_report_line_3 = self._prepare_test_report_line(
            self._prepare_test_expression_aggregation(
                "other_report_line_1.balance + other_report_line_2.balance"
            ),
            name="other_report_line_3",
            code="other_report_line_3",
        )

        other_report_line_4 = self._prepare_test_report_line(
            self._prepare_test_expression_account_codes("3"),
            name="other_report_line_4",
            code="other_report_line_4",
        )
        ...
        other_report_options = self._generate_options(
            other_report, "2021-01-01", "2021-01-01"
        )

        # Main report
        main_report_line_1 = self._prepare_test_report_line(
            self._prepare_test_expression_aggregation(
                "other_report_line_2.balance",
                subformula="cross_report",
                date_scope="strict_range",
            ),
            name="main_report_line_1",
            code="main_report_line_1",
        )
        ...
        main_report_line_2 = self._prepare_test_report_line(
            ...
            name="main_report_line_2",
            code="main_report_line_2",
        )

        main_report_line_3 = self._prepare_test_report_line(
            self._prepare_test_expression_aggregation(
                "other_report_line_3.balance",
                subformula="cross_report",
                date_scope="strict_range",
            ),
            name="main_report_line_3",
            code="main_report_line_3",
        )
        ...
        main_report_line_4 = self._prepare_test_report_line(
            ...
            name="main_report_line_4",
            code="main_report_line_4",
        )
        ...
        main_report = self._create_report(
            [
                main_report_line_1,
                main_report_line_2,
                main_report_line_3,
    ...
    def test_engine_aggregation_cross_bound(self):
        report_1 = self._create_report(
            [
                self._prepare_test_report_line(
                    self._prepare_test_expression_aggregation(
                        "line_2_1.balance", subformula="cross_report"
                    ),
                    name="Line 1-1",
                    code="line_1_1",
                ),
