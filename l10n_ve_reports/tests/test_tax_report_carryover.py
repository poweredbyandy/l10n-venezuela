...
class TestTaxReportCarryover(TestAccountReportsCommon):
    ...
    def test_tax_report_carry_over(self):
        ...
        with patch.object(
            ...
            ]._generate_tax_closing_entries(self.report, options)
    ...
    def test_tax_report_carry_over_tax_unit(self):
        ...
        with patch.object(
            ...
            main_closing_move = vat_closing_moves.filtered(
                lambda x: x.company_id == self.company_1
            )
        ...
        # There should be no carryover pop-up
        self.assertTrue(
            "info_popup_data" not in lines_company_2[0]["columns"][0].keys()
        )
        ...
        self.assertTrue(
            "info_popup_data" not in lines_company_1[0]["columns"][0].keys()
        )
