...
class BankReconciliationReportCustomHandler(models.AbstractModel):
    ...
    def _report_custom_engine_misc_operations(
        ...
        if not current_groupby:
            ...
            return [
                (
                    grouping_key,
                    self._build_custom_engine_result(
    ...
    def _bank_reconciliation_report_custom_engine_common(
        ...
        query = SQL(
         ...
         GROUP BY %(group_by)s,
            ...
            is_unreconciled=SQL("AND NOT st_line.is_reconciled")
            if unreconciled
            else SQL(""),
    ...
    def _customize_warnings(
        ...
        if warnings is not None:
            if last_statement and general_ledger_not_matching:
                warnings["l10n_ve_reports.journal_balance"] = {
                    "alert_type": "warning",
            ...
            if inconsistent_statement:
                warnings["l10n_ve_reports.inconsistent_statement_warning"] = {
                    "alert_type": "warning",
                    "args": inconsistent_statement,
                }
            if has_bank_miscellaneous_move_lines:
                warnings["l10n_ve_reports.has_bank_miscellaneous_move_lines"] = {
                    "alert_type": "warning",
    ...
    def action_redirect_to_bank_statement_widget(self, options):
        ...
        ]._action_open_bank_reconciliation_widget(
            default_context={
                "create": False,
