...
class ResConfigSettings(models.TransientModel):
    ...
    def _compute_account_reports_show_per_company_setting(self):
        ...
        for config_settings in self:
            config_settings.account_reports_show_per_company_setting = bool(
                set(countries.mapped("code")) & custom_start_country_codes
            )
    ...
    def open_company_dependent_report_settings(self):
        ...
        return {
            ...
            "views": [
                (
                    self.env.ref(
                        "l10n_ve_reports.account_report_tree_configure_start_dates"
                    ).id,
                    "list",
                )
            ],
