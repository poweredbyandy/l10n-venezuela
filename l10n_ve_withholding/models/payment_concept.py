...
class PaymentConcept(models.Model):
    ...
    line_payment_concept_ids = fields.One2many(
        "payment.concept.line", "payment_concept_id", "Payment Concept Line", store=True
    )
        ...
        concept_lines = [
            {
                ...
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_substrat_l10n_ve_withholding"
                ).id,
            ...
            },
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_percentage_one_l10n_ve_withholding"
                ).id,
                "type_person_id": self.env.ref(
            ...
            },
            {
                ...
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_percentage_two_l10n_ve_withholding"
                ).id,
                "type_person_id": self.env.ref(
            ...
            },
            {
                ...
                "percentage_tax_base": 90,
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_percentage_five_l10n_ve_withholding"
                ).id,
                "type_person_id": self.env.ref(
        ...
        concept_lines = [
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_substrat_second_l10n_ve_withholding"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_withholding.type_person_l10n_ve_withholding"
                ).id,
            },
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_percentage_four_l10n_ve_withholding"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_withholding.type_person_three_l10n_ve_withholding"
                ).id,
    ...
    def _handle_payment_concept_three(self):
        ...
        concept_lines = [
            ...
            },
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_withholding.fees_retention_data_l10n_ve_percentage_three_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_withholding.type_person_three_l10n_ve_withholding"
                ).id,
    ...
    def _handle_payment_concept_six(self):
        ...
        concept_lines = [
            ...
            },
            {
                ...
                "type_person_id": self.env.ref(
                    "l10n_ve_withholding.type_person_seven_l10n_ve_withholding"
                ).id,
            },
        ]
            ...
            concept = self.env["payment.concept"].create(
                {
                    ...
                    "line_payment_concept_ids": [
                        (0, 0, line) for line in new_concept_lines
                    ],
                }
            )
        else:
    ...
    def validate_concept_lines(self, concept_lines):
        ...
        return [
            line for line in concept_lines if str(line["code"]) not in existing_codes
        ]
