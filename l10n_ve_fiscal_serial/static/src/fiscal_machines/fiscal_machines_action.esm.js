...
export class FiscalMachinesAction extends Component {
    ...
    _syncFpStatusFromDriver() {
        ...
        this.state.fpStatus = st != null && String(st) !== "" ? String(st) : "";
        this.state.fpError = er != null && String(er) !== "" ? String(er) : "";
...
registry
    .category("actions")
    .add("l10n_ve_fiscal_serial_fiscal_machines", FiscalMachinesAction);
